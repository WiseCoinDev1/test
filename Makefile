#############################################################################
# Makefile for building: osiris-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Thu Mar 29 03:37:03 2018
# Project:  zaca.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile zaca.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DENABLE_WALLET -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DBOOST_VARIANT_USE_RELAXED_GET_BY_DEFAULT -DHAVE_BUILD_INFO -DUSE_UPNP=1 -DMINIUPNP_STATICLIB -DSTATICLIB -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu /home/osiris/build/osiriscoin/src/leveldb/libleveldb.a /home/osiris/build/osiriscoin/src/leveldb/libmemenv.a /home/osiris/build/osiriscoin/src/secp256k1/src/libsecp256k1_la-secp256k1.o -lminiupnpc -lssl -lcrypto -ldb_cxx -lgmp -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
/home/osiris/build/osiriscoin/src/leveldb/libleveldb.a: FORCE
	cd /home/osiris/build/osiriscoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/osiris/build/osiriscoin/src/secp256k1/src/libsecp256k1_la-secp256k1.o: FORCE
	cd /home/osiris/build/osiriscoin/src/secp256k1 && ./autogen.sh && ./configure --enable-module-recovery && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2"

/home/osiris/build/osiriscoin/build/build.h: FORCE
	cd /home/osiris/build/osiriscoin; /bin/sh share/genbuild.sh /home/osiris/build/osiriscoin/build/build.h
