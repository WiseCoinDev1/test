...
int nAnonymizeOsirisAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Osiris
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Osiris
    // Mac: ~/Library/Application Support/Osiris
    // Unix: ~/.osiris
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Osiris";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "osiris.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Osirisd.pid"));
