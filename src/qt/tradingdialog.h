...
private slots:
    ...
    QString BuyOSI(QString OrderType, double Quantity, double Rate);
    QString SellOSI(QString OrderType, double Quantity, double Rate);
