...
void OverviewPage::updateDarksendProgress()
{
    ...
    QString strAnonymizeOsirisAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeOsirisAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strAnonymizeOsirisAmount = strAnonymizeOsirisAmount.remove(strAnonymizeOsirisAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeOsirisAmount + " OSI / " + tr("%n Rounds", "", nDarksendRounds);
    ...
    if(nMaxToAnonymize > nAnonymizeOsirisAmount*COIN) nMaxToAnonymize = nAnonymizeOsirisAmount*COIN;

    if(nMaxToAnonymize == 0) return;

    if(nMaxToAnonymize >= nAnonymizeOsirisAmount * COIN) {
        ui->labelAmountRounds->setToolTip(tr("Found enough compatible inputs to anonymize %1")
                                          .arg(strAnonymizeOsirisAmount));
        strAnonymizeOsirisAmount = strAnonymizeOsirisAmount.remove(strAnonymizeOsirisAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeOsirisAmount + " OSI / " + tr("%n Rounds", "", nDarksendRounds);
    } else {
        ...
        strAmountAndRounds = "<span style='color:red;'>" +
                ...
                " OSI / " + tr("%n Rounds", "", nDarksendRounds) + "</span>";
    }
    ui->labelAmountRounds->setText(strAmountAndRounds);
