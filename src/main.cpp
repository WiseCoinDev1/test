...
// Copyright (c) 2018 Osiris developers
...
const string strMessageMagic = "Osiris Signed Message:\n";
...
int64_t GetSuperBlockReward(int nHeight)
{
    int64_t nSuperBlockReward = 1 * COIN;
    switch (nHeight)
    {
        case 1:
            nSuperBlockReward *= 1050000;
            break;
        case 1440:
        case 3440:
        case 5000:
        case 10000:
        case 15000:
            nSuperBlockReward *= 2000;
            break;
        case 20000:
            nSuperBlockReward *= 3000;
            break;
        case 40000:
            nSuperBlockReward *= 4000;
            break;
        case 80000:
            nSuperBlockReward *= 5000;
            break;
        case 150000:
            nSuperBlockReward *= 6000;
            break;
        case 300000:
            nSuperBlockReward *= 7000;
            break;
        case 400000:
            nSuperBlockReward *= 8000;
            break;
        case 500000:
            nSuperBlockReward *= 10000;
            break;
        default:
            nSuperBlockReward *= 0;
        }

    return nSuperBlockReward;
}

int64_t GetBlockReward(int nHeight)
{
    int64_t nBlockReward = 1 * COIN;
    ...
    return nBlockReward + GetSuperBlockReward(nHeight);
}

// miner's coin base reward
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    int64_t nSubsidy = GetBlockReward(nHeight);
...
static int64_t nTargetTimespan = 4 * 60;  // 4 mins
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
    ...
    nTargetTimespan = 4 * 60; // 4 minutes
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (TestNet())
    {
//        nCoinbaseMaturity = 30; // test maturity is 10 blocks
...
{
    int64_t nMasterReward = blockValue;
