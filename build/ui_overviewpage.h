...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelDarksendSyncStatus->setObjectName(QString::fromUtf8("labelDarksendSyncStatus"));
        labelDarksendSyncStatus->setStyleSheet(QString::fromUtf8("QLabel { color: red; }"));
        labelDarksendSyncStatus->setText(QString::fromUtf8("(out of sync)"));
        ...
        runAutoDenom->setObjectName(QString::fromUtf8("runAutoDenom"));
        QPalette palette;
        ...
        labelAnonymized->setText(QString::fromUtf8("0 OSI"));
        ...
        lineLastMessage->setObjectName(QString::fromUtf8("lineLastMessage"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Osiris network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        labelWatchStake->setToolTip(QApplication::translate("OverviewPage", "Total of coins that was staked in watch-only addresses, and do not yet count toward the current watch-only balance", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelDarksendSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Osiris network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 OSI / 0 Rounds", 0, QApplication::UnicodeUTF8));
        ...
        darksendEnabled->setText(QApplication::translate("OverviewPage", "Enabled/Disabled", 0, QApplication::UnicodeUTF8));
        ...
        toggleDarksend->setText(QApplication::translate("OverviewPage", "Start/Stop Mixing", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Osiris network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
