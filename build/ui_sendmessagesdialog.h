...
public:
    ...
    void setupUi(QDialog *SendMessagesDialog)
    {
        ...
        SendMessagesDialog->setStyleSheet(QString::fromUtf8("#SendMessagesDialog { background-color: #383838; }"));
        ...
        addressFromLabel->setStyleSheet(QString::fromUtf8("color: #ffffff;"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 830, 298));
