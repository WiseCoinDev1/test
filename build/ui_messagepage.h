...
public:
    ...
    void setupUi(QWidget *MessagePage)
    {
        ...
        listConversation->setStyleSheet(QString::fromUtf8("#listConversation { color: #000000; }"));
...
#ifndef QT_NO_TOOLTIP
        sendButton->setToolTip(QApplication::translate("MessagePage", "Sign a message to prove you own a Osiris address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
