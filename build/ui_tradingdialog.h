...
public:
    ...
    QLabel *label_11;
    QLabel *OSIBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *OSIAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *OSIPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        if (tradingDialog->objectName().isEmpty())
            tradingDialog->setObjectName(QString::fromUtf8("tradingDialog"));
        tradingDialog->resize(1031, 597);
        verticalLayout = new QVBoxLayout(tradingDialog);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        tradingHeaderContainer = new QFrame(tradingDialog);
        tradingHeaderContainer->setObjectName(QString::fromUtf8("tradingHeaderContainer"));
        ...
        verticalLayout_trade->setObjectName(QString::fromUtf8("verticalLayout_trade"));
        wallettradeHeader = new QHBoxLayout();
        wallettradeHeader->setObjectName(QString::fromUtf8("wallettradeHeader"));
        ...
        volumet->setObjectName(QString::fromUtf8("volumet"));
        ...
        volumebtc->setObjectName(QString::fromUtf8("volumebtc"));
        ...
        TradingTabWidget->setObjectName(QString::fromUtf8("TradingTabWidget"));
        ...
        BuyTab = new QWidget();
        BuyTab->setObjectName(QString::fromUtf8("BuyTab"));
        ...
        AsksTable->setObjectName(QString::fromUtf8("AsksTable"));
        ...
        label232->setObjectName(QString::fromUtf8("label232"));
        label232->setFont(font3);

        horizontalLayout_3->addWidget(label232);

        BtcAvailableLabel = new QLabel(BuyTab);
        BtcAvailableLabel->setObjectName(QString::fromUtf8("BtcAvailableLabel"));
        QPalette palette;
        ...
        labelBTC->setObjectName(QString::fromUtf8("labelBTC"));
        ...
        label232_2->setObjectName(QString::fromUtf8("label232_2"));
        label232_2->setFont(font3);

        horizontalLayout->addWidget(label232_2);

        OSIAvailableLabel = new QLabel(BuyTab);
        OSIAvailableLabel->setObjectName(QString::fromUtf8("OSIAvailableLabel"));
        QPalette palette1;
        ...
        OSIAvailableLabel->setPalette(palette1);
        OSIAvailableLabel->setFont(font3);
        OSIAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(OSIAvailableLabel);

        labelOSI = new QLabel(BuyTab);
        labelOSI->setObjectName(QString::fromUtf8("labelOSI"));
        labelOSI->setFont(font3);

        horizontalLayout->addWidget(labelOSI);


        gridLayout_6->addLayout(horizontalLayout, 3, 8, 1, 2);

        Buy_Max_Amount = new QPushButton(BuyTab);
        Buy_Max_Amount->setObjectName(QString::fromUtf8("Buy_Max_Amount"));
        QFont font4;
        ...
        UnitsInput->setObjectName(QString::fromUtf8("UnitsInput"));
        ...
        Sell_Max_Amount->setObjectName(QString::fromUtf8("Sell_Max_Amount"));
        Sell_Max_Amount->setFont(font4);

        gridLayout_6->addWidget(Sell_Max_Amount, 4, 8, 1, 1);

        UnitsInputOSI = new QLineEdit(BuyTab);
        UnitsInputOSI->setObjectName(QString::fromUtf8("UnitsInputOSI"));
        UnitsInputOSI->setMinimumSize(QSize(0, 0));
        UnitsInputOSI->setFont(font5);

        gridLayout_6->addWidget(UnitsInputOSI, 4, 9, 1, 1);
        ...
        BuyBidcomboBox->setObjectName(QString::fromUtf8("BuyBidcomboBox"));
        BuyBidcomboBox->setFont(font4);

        gridLayout_6->addWidget(BuyBidcomboBox, 5, 2, 1, 1);

        BuyBidPriceEdit = new QLineEdit(BuyTab);
        BuyBidPriceEdit->setObjectName(QString::fromUtf8("BuyBidPriceEdit"));
        ...
        SellBidcomboBox->setObjectName(QString::fromUtf8("SellBidcomboBox"));
        SellBidcomboBox->setFont(font4);

        gridLayout_6->addWidget(SellBidcomboBox, 5, 8, 1, 1);

        SellBidPriceEdit = new QLineEdit(BuyTab);
        SellBidPriceEdit->setObjectName(QString::fromUtf8("SellBidPriceEdit"));
        ...
        BuyCostLabel->setObjectName(QString::fromUtf8("BuyCostLabel"));
        QPalette palette2;
        ...
        SellCostLabel->setObjectName(QString::fromUtf8("SellCostLabel"));
        QPalette palette3;
        ...
        BuyOSI = new QPushButton(BuyTab);
        BuyOSI->setObjectName(QString::fromUtf8("BuyOSI"));

        gridLayout_6->addWidget(BuyOSI, 7, 3, 1, 1);

        SellOSIBTN = new QPushButton(BuyTab);
        SellOSIBTN->setObjectName(QString::fromUtf8("SellOSIBTN"));

        gridLayout_6->addWidget(SellOSIBTN, 7, 9, 1, 1);

        BidsTable = new QTableWidget(BuyTab);
        BidsTable->setObjectName(QString::fromUtf8("BidsTable"));
        ...
        BtcDemand->setObjectName(QString::fromUtf8("BtcDemand"));
        ...
        AsksCount->setObjectName(QString::fromUtf8("AsksCount"));

        gridLayout_6->addWidget(AsksCount, 1, 7, 1, 2);

        BtcSupply = new QLabel(BuyTab);
        BtcSupply->setObjectName(QString::fromUtf8("BtcSupply"));
        BtcSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(BtcSupply, 1, 9, 1, 3);

        OSIDemand = new QLabel(BuyTab);
        OSIDemand->setObjectName(QString::fromUtf8("OSIDemand"));
        QFont font6;
        font6.setPointSize(8);
        OSIDemand->setFont(font6);
        OSIDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(OSIDemand, 0, 1, 1, 5);

        OSISupply = new QLabel(BuyTab);
        OSISupply->setObjectName(QString::fromUtf8("OSISupply"));
        OSISupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(OSISupply, 0, 9, 1, 3);

        BidsCount = new QLabel(BuyTab);
        BidsCount->setObjectName(QString::fromUtf8("BidsCount"));
        ...
        CSDumpLabel->setObjectName(QString::fromUtf8("CSDumpLabel"));
        QPalette palette4;
        ...
        CSTotalLabel->setObjectName(QString::fromUtf8("CSTotalLabel"));
        QPalette palette5;
        ...
        CSReceiveLabel->setObjectName(QString::fromUtf8("CSReceiveLabel"));
        QPalette palette6;
        ...
        CSUnitsInput->setObjectName(QString::fromUtf8("CSUnitsInput"));
        ...
        BittrexOSILabel = new QLabel(tab);
        BittrexOSILabel->setObjectName(QString::fromUtf8("BittrexOSILabel"));
        QPalette palette7;
        ...
        BittrexOSILabel->setPalette(palette7);
        BittrexOSILabel->setFont(font7);
        BittrexOSILabel->setAutoFillBackground(false);
        BittrexOSILabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexOSILabel);
        ...
        BittrexBTCLabel->setObjectName(QString::fromUtf8("BittrexBTCLabel"));
        QPalette palette8;
        ...
        label232_4->setObjectName(QString::fromUtf8("label232_4"));
        QFont font9;
        ...
        OSIBalanceLabel = new QLabel(BalanceTab);
        OSIBalanceLabel->setObjectName(QString::fromUtf8("OSIBalanceLabel"));
        OSIBalanceLabel->setFont(font4);
        OSIBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(OSIBalanceLabel, 0, 3, 1, 1);
        ...
        BitcoinBalanceLabel->setObjectName(QString::fromUtf8("BitcoinBalanceLabel"));
        ...
        OSIAvailableLabel_2 = new QLabel(BalanceTab);
        OSIAvailableLabel_2->setObjectName(QString::fromUtf8("OSIAvailableLabel_2"));
        OSIAvailableLabel_2->setFont(font4);
        OSIAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(OSIAvailableLabel_2, 1, 3, 1, 1);
        ...
        BitcoinAvailableLabel->setObjectName(QString::fromUtf8("BitcoinAvailableLabel"));
        ...
        OSIPendingLabel = new QLabel(BalanceTab);
        OSIPendingLabel->setObjectName(QString::fromUtf8("OSIPendingLabel"));
        OSIPendingLabel->setFont(font4);
        OSIPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(OSIPendingLabel, 2, 3, 1, 1);
        ...
        BitcoinPendingLabel->setObjectName(QString::fromUtf8("BitcoinPendingLabel"));
        ...
        GenDepositBTN->setObjectName(QString::fromUtf8("GenDepositBTN"));
        ...
        DepositAddressLabel->setObjectName(QString::fromUtf8("DepositAddressLabel"));
        ...
        DepositCopyButton->setObjectName(QString::fromUtf8("DepositCopyButton"));
        QIcon icon1;
        ...
        WithdrawUnitsInput->setObjectName(QString::fromUtf8("WithdrawUnitsInput"));
        ...
        Withdraw_Max_Amount->setObjectName(QString::fromUtf8("Withdraw_Max_Amount"));
        ...
        WithdrawAddress->setObjectName(QString::fromUtf8("WithdrawAddress"));
        ...
        WithdrawPasteButton->setObjectName(QString::fromUtf8("WithdrawPasteButton"));
        ...
        WithdrawUnitsBtn->setObjectName(QString::fromUtf8("WithdrawUnitsBtn"));
        ...
        OSIBalanceLabel->raise();
        OSIAvailableLabel_2->raise();
        OSIPendingLabel->raise();
        ...
        ApiKeyInput->setObjectName(QString::fromUtf8("ApiKeyInput"));

        gridLayout->addWidget(ApiKeyInput, 0, 1, 1, 3);

        KeyPasteButton = new QToolButton(ApiSettings);
        KeyPasteButton->setObjectName(QString::fromUtf8("KeyPasteButton"));
        ...
        SecretKeyInput->setObjectName(QString::fromUtf8("SecretKeyInput"));

        gridLayout->addWidget(SecretKeyInput, 1, 1, 1, 3);

        SecretPasteButton = new QToolButton(ApiSettings);
        SecretPasteButton->setObjectName(QString::fromUtf8("SecretPasteButton"));
        ...
        label232_17->setObjectName(QString::fromUtf8("label232_17"));
        ...
        label232_16->setObjectName(QString::fromUtf8("label232_16"));
    ...
    {
        tradingDialog->setWindowTitle(QApplication::translate("tradingDialog", "Dialog", 0, QApplication::UnicodeUTF8));
        Bid->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        volumet->setText(QApplication::translate("tradingDialog", "0.000000000", 0, QApplication::UnicodeUTF8));
        Ask->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        volumebtc->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("tradingDialog", "Units", 0, QApplication::UnicodeUTF8));
        label232->setText(QApplication::translate("tradingDialog", "BTC Available:", 0, QApplication::UnicodeUTF8));
        BtcAvailableLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        labelBTC->setText(QApplication::translate("tradingDialog", "BTC", 0, QApplication::UnicodeUTF8));
        label232_2->setText(QApplication::translate("tradingDialog", "OSI Available:", 0, QApplication::UnicodeUTF8));
        OSIAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0, QApplication::UnicodeUTF8));
        labelOSI->setText(QApplication::translate("tradingDialog", " OSI", 0, QApplication::UnicodeUTF8));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("tradingDialog", "OSI", 0, QApplication::UnicodeUTF8));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0, QApplication::UnicodeUTF8));
        label_22->setText(QApplication::translate("tradingDialog", "OSI", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("tradingDialog", "Bid", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("tradingDialog", "BTC", 0, QApplication::UnicodeUTF8));
        label_16->setText(QApplication::translate("tradingDialog", "BTC", 0, QApplication::UnicodeUTF8));
        label_23->setText(QApplication::translate("tradingDialog", "Total w/ 0.25% Fee ", 0, QApplication::UnicodeUTF8));
        BuyCostLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0, QApplication::UnicodeUTF8));
        label_24->setText(QApplication::translate("tradingDialog", " BTC", 0, QApplication::UnicodeUTF8));
        label_19->setText(QApplication::translate("tradingDialog", "Total w/ 0.25% Fee ", 0, QApplication::UnicodeUTF8));
        SellCostLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0, QApplication::UnicodeUTF8));
        label_17->setText(QApplication::translate("tradingDialog", " BTC", 0, QApplication::UnicodeUTF8));
        BuyOSI->setText(QApplication::translate("tradingDialog", "Buy OSI", 0, QApplication::UnicodeUTF8));
        SellOSIBTN->setText(QApplication::translate("tradingDialog", "Sell OSI", 0, QApplication::UnicodeUTF8));
        BtcDemand->setText(QApplication::translate("tradingDialog", "0.00000000 BTC", 0, QApplication::UnicodeUTF8));
        AsksCount->setText(QApplication::translate("tradingDialog", "Asks: 0000", 0, QApplication::UnicodeUTF8));
        BtcSupply->setText(QApplication::translate("tradingDialog", "0.00000000 BTC", 0, QApplication::UnicodeUTF8));
        OSIDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 OSI", 0, QApplication::UnicodeUTF8));
        OSISupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 OSI", 0, QApplication::UnicodeUTF8));
        BidsCount->setText(QApplication::translate("tradingDialog", "Bids: 0000", 0, QApplication::UnicodeUTF8));
        TradingTabWidget->setTabText(TradingTabWidget->indexOf(BuyTab), QApplication::translate("tradingDialog", "Trade", 0, QApplication::UnicodeUTF8));
        label_21->setText(QApplication::translate("tradingDialog", "Lowest price:", 0, QApplication::UnicodeUTF8));
        CSDumpLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0, QApplication::UnicodeUTF8));
        label_25->setText(QApplication::translate("tradingDialog", "BTC", 0, QApplication::UnicodeUTF8));
        label_32->setText(QApplication::translate("tradingDialog", "Amount in OSI:", 0, QApplication::UnicodeUTF8));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0, QApplication::UnicodeUTF8));
        label_35->setText(QApplication::translate("tradingDialog", "OSI", 0, QApplication::UnicodeUTF8));
        label_20->setText(QApplication::translate("tradingDialog", "Total w/ Fees :", 0, QApplication::UnicodeUTF8));
        CSReceiveLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0, QApplication::UnicodeUTF8));
        label_18->setText(QApplication::translate("tradingDialog", "BTC", 0, QApplication::UnicodeUTF8));
        CSUnitsBtn->setText(QApplication::translate("tradingDialog", "Send", 0, QApplication::UnicodeUTF8));
        label232_8->setText(QString());
        label232_13->setText(QApplication::translate("tradingDialog", "<html><head/><body><p><span style=\" font-size:9pt; font-weight:600;\">Warning:</span><span style=\" font-size:9pt;\"> This feature is in </span><span style=\" font-size:9pt; font-weight:600;\">ALPHA ! USE AT OWN RISK !</span></p></body></html>", 0, QApplication::UnicodeUTF8));
        label232_15->setText(QApplication::translate("tradingDialog", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; text-decoration: underline;\">Instructions:</span></p><p align=\"center\">To use the cross sending feature you need to have </p><p align=\"center\">OSI available to spend on Bittrex. If you don't have any </p><p align=\"center\">you can find your deposit address on the &quot;Balance&quot; tab.</p><p align=\"center\">1. Enter the amount you want to receive in Bitcoin.</p><p align=\"center\">2. Enter the Bitcoin address you are sending to.</p><p align=\"center\">3. Check that the Total with fee's is correct.</p><p align=\"center\">4. Press send and watch the magic happen.</p><p align=\"center\"><span style=\" font-weight:600; text-decoration: underline;\">Notes.</span></p><p align=\"center\"><span style=\" font-size:7pt;\">Total w/ fees: N/A means you dont have enough OSI to sell !</span></p><p align=\"center\"><span style=\" font-size:7pt;\">All trades are done through Bittrex using your own balance and API keys.</span></p><p align=\"center\""
                        "><span style=\" font-size:7pt;\">Encrypt and backup your wallet when using this feature.</span></p><p align=\"center\"><span style=\" font-size:7pt;\">If you don't have a password you bittrex account will be accessible 24/7</span></p><p align=\"center\"><span style=\" font-size:7pt;\">Withdrawal fee of 0.002 and 0.25% taken by Bittrex.</span></p></body></html>", 0, QApplication::UnicodeUTF8));
        label_27->setText(QApplication::translate("tradingDialog", "Amount:", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("tradingDialog", "Address:", 0, QApplication::UnicodeUTF8));
        label_29->setText(QApplication::translate("tradingDialog", "OSI Balance:", 0, QApplication::UnicodeUTF8));
        BittrexOSILabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0, QApplication::UnicodeUTF8));
        label_30->setText(QApplication::translate("tradingDialog", "OSI", 0, QApplication::UnicodeUTF8));
        label_36->setText(QApplication::translate("tradingDialog", "BTC Balance:", 0, QApplication::UnicodeUTF8));
        BittrexBTCLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0, QApplication::UnicodeUTF8));
        label_37->setText(QApplication::translate("tradingDialog", "BTC", 0, QApplication::UnicodeUTF8));
        CS_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        CSPasteButton->setToolTip(QApplication::translate("tradingDialog", "Paste from clipboard", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        CSPasteButton->setText(QString());
        CSPasteButton->setShortcut(QApplication::translate("tradingDialog", "Alt+P", 0, QApplication::UnicodeUTF8));
        label232_4->setText(QApplication::translate("tradingDialog", "Cross-Send", 0, QApplication::UnicodeUTF8));
        TradingTabWidget->setTabText(TradingTabWidget->indexOf(tab), QApplication::translate("tradingDialog", "Send", 0, QApplication::UnicodeUTF8));
        TradingTabWidget->setTabText(TradingTabWidget->indexOf(MarketHistory), QApplication::translate("tradingDialog", "Market History", 0, QApplication::UnicodeUTF8));
        TradingTabWidget->setTabText(TradingTabWidget->indexOf(OpenOrders), QApplication::translate("tradingDialog", "Open Orders", 0, QApplication::UnicodeUTF8));
        TradingTabWidget->setTabText(TradingTabWidget->indexOf(TradeHistory), QApplication::translate("tradingDialog", "Trade history", 0, QApplication::UnicodeUTF8));
        label_11->setText(QApplication::translate("tradingDialog", "OSI Balance:", 0, QApplication::UnicodeUTF8));
        OSIBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        label_12->setText(QApplication::translate("tradingDialog", "BTC Balance:", 0, QApplication::UnicodeUTF8));
        BitcoinBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        label_13->setText(QApplication::translate("tradingDialog", "OSI Available:", 0, QApplication::UnicodeUTF8));
        OSIAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        label_15->setText(QApplication::translate("tradingDialog", "BTC Available:", 0, QApplication::UnicodeUTF8));
        BitcoinAvailableLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        label_14->setText(QApplication::translate("tradingDialog", "OSI Pending:", 0, QApplication::UnicodeUTF8));
        OSIPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        label_31->setText(QApplication::translate("tradingDialog", "BTC Pending:", 0, QApplication::UnicodeUTF8));
        BitcoinPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0, QApplication::UnicodeUTF8));
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate OSI Coin Deposit Address", 0, QApplication::UnicodeUTF8));
        label_33->setText(QApplication::translate("tradingDialog", "Deposit Address:", 0, QApplication::UnicodeUTF8));
        DepositAddressLabel->setText(QString());
#ifndef QT_NO_TOOLTIP
        DepositCopyButton->setToolTip(QApplication::translate("tradingDialog", "Copy to clipboard", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        DepositCopyButton->setText(QString());
        DepositCopyButton->setShortcut(QApplication::translate("tradingDialog", "Alt+P", 0, QApplication::UnicodeUTF8));
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw OSI:", 0, QApplication::UnicodeUTF8));
        label_26->setText(QApplication::translate("tradingDialog", "Amount:", 0, QApplication::UnicodeUTF8));
        WithdrawUnitsInput->setText(QString());
        Withdraw_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("tradingDialog", "Address:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        WithdrawPasteButton->setToolTip(QApplication::translate("tradingDialog", "Paste from clipboard", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        WithdrawPasteButton->setText(QString());
        WithdrawPasteButton->setShortcut(QApplication::translate("tradingDialog", "Alt+P", 0, QApplication::UnicodeUTF8));
        WithdrawUnitsBtn->setText(QApplication::translate("tradingDialog", "Withdraw", 0, QApplication::UnicodeUTF8));
        TradingTabWidget->setTabText(TradingTabWidget->indexOf(BalanceTab), QApplication::translate("tradingDialog", "Balance", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("tradingDialog", "API Key", 0, QApplication::UnicodeUTF8));
        ApiKeyInput->setText(QString());
#ifndef QT_NO_TOOLTIP
        KeyPasteButton->setToolTip(QApplication::translate("tradingDialog", "Paste from clipboard", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        KeyPasteButton->setText(QString());
        KeyPasteButton->setShortcut(QApplication::translate("tradingDialog", "Alt+P", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("tradingDialog", "Secret Key", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        SecretPasteButton->setToolTip(QApplication::translate("tradingDialog", "Paste from clipboard", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        SecretPasteButton->setText(QString());
        SecretPasteButton->setShortcut(QApplication::translate("tradingDialog", "Alt+P", 0, QApplication::UnicodeUTF8));
        label_28->setText(QApplication::translate("tradingDialog", "Password", 0, QApplication::UnicodeUTF8));
        LoadKeys->setText(QApplication::translate("tradingDialog", "Load API Keys", 0, QApplication::UnicodeUTF8));
        UpdateKeys->setText(QApplication::translate("tradingDialog", "Update API Keys", 0, QApplication::UnicodeUTF8));
        SaveKeys->setText(QApplication::translate("tradingDialog", "Save API Keys", 0, QApplication::UnicodeUTF8));
        label232_17->setText(QApplication::translate("tradingDialog", "<html><head/><body><p>Loading keys:</p><p>1) Enter Password</p><p>2) Load API Keys</p><p>3) Start trading on Bittrex</p></body></html>", 0, QApplication::UnicodeUTF8));
        label232_16->setText(QApplication::translate("tradingDialog", "<html><head/><body><p>Saving keys:</p><p>1) Enter in API Keys found at <a href=\"https://bittrex.com/Account/ManageApiKey\"><span style=\" text-decoration: underline; color:#0000ff;\">Bittrex</span></a></p><p>2) Enter Password</p><p>3) Save API Keys</p><p>4) Start trading on Bittrex</p></body></html>", 0, QApplication::UnicodeUTF8));
        TradingTabWidget->setTabText(TradingTabWidget->indexOf(ApiSettings), QApplication::translate("tradingDialog", "Settings", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
